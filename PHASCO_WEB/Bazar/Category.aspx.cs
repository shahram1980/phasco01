...
namespace BiztBiz
{
    public partial class Category : BasePage
    {
        ...
        {
            int pagesize = 0;
            pagesize = PHASCOUtility.ConverToNullableInt(ddlItemCount.SelectedValue);
        ...
        protected string SelectCounInCat(string CatName, string groupID)
        {
            ...
            return "<table><tr><td style='text-align: right;direction:ltr;'>" + CatName + "</td><td>(" + count + ")</td></tr></table>"   ;
        ...
        protected string SelectCountRequestInCategory(string groupID)
        {
            ...
            DataTable dtCountRequest = da_Request.TBL_RequestByGroups("selectCount_cat1", PHASCOUtility.ConverToNullableInt(groupID));
        ...
        protected string SelectCountProductInCategory(string groupID)
        {
            ...
            DataTable dtCountProduct = da_Products.Tbl_ProductsByGroupID("selectCount_cat1", PHASCOUtility.ConverToNullableInt(groupID));
        ...
        protected void BindProductList()
        {
            ...
            if (dtProducts.Rows.Count > 0)
                pagerProduct.ItemCount = PHASCOUtility.ConverToNullableInt(dtProducts.Rows[0]["ItemCount"]);
            else
        ...
        protected void BindRequestList()
        {
            ...
            if (dtRequests.Rows.Count > 0)
                pagerRequest.ItemCount = PHASCOUtility.ConverToNullableInt(dtRequests.Rows[0]["ItemCount"]);
            else
        ...
        public string GetShamsi_Date(string date)
        {
        ...
        {
            int pagesize = PHASCOUtility.ConverToNullableInt(ddlItemCount.SelectedValue);
            if (pagesize > 0)
            {
                pagerProduct.PageSize = pagesize;
                pagerRequest.PageSize = pagesize;
        ...
        public string GetProductImage(string image, string imagepath)
        {
            if (PHASCOUtility.ConverToNullableInt(image) == 1)
                return "http://phasco.com/bazar/MyBiztBiz/Pupload/" + imagepath;
            else
                return "http://phasco.com/bazar/MyBiztBiz/Pupload/None/NONE.jpg";
        }

        public string GetCompanyImage(string image)
        {
            if (image != "none.jpg")
                return "http://phasco.com/bazar/MyBiztBiz/Coupload/" + image;
            else
                return "http://phasco.com/bazar/MyBiztBiz/Pupload/None/NONE.jpg";
        }
