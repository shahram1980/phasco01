<%@ Page Language="C#" MasterPageFile="~/Bazar/Template/CompanyDeteil.Master" AutoEventWireup="true"
    CodeBehind="About.aspx.cs" Inherits="BiztBiz.C_p.About" %>
            ...
            <table class="style1">
                ...
                <tr>
                    <td>
                        ...
                        :
                        <asp:Label ID="Label_registered_capital" runat="server" /><br />
                        <br />
                        <asp:Literal ID="Literal2" runat="server" Text="<%$ Resources:Resource, annual_sales %>" />
                        :
                        <asp:Label ID="Label_annual_sales" runat="server" /><br />
                        <br />
                        ...
                        :
                        <asp:Label ID="Label_Main_Products_or_Services" runat="server" /><br />
                        <br />
                        <asp:Literal ID="Literal5" runat="server" Text="<%$ Resources:Resource, Main_Markets %>" />
                        :
                        <asp:Label ID="Label_Main_Markets" runat="server" /><br />
                        <br />
                    </td>
                </tr>
                <tr>
