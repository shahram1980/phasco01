    ...
    public partial class Request : BasePage
    {
        ...
        protected void BindRequestsDetails(int requestID)
        {
            ...
            if (dtRequest.Rows.Count > 0)
            {
                ...
                lnkContents.HRef = "~/Contact.aspx?TypeID=2&CompanyID=" + dtRequest.Rows[0]["Uid_id"].ToString() + "&ReciverID=" + dtRequest.Rows[0]["Uid_id"].ToString();
        ...
        public string GetStateAndCity(string cityID)
        {
            ...
            if (dtState.Rows.Count > 0)
            {
                stateAndCity += dtState.Rows[0]["Satate"].ToString() + " / " + dtState.Rows[0]["City"].ToString();
            }
