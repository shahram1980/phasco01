    ...
    public partial class SubmitProducts : System.Web.UI.Page
    {
        ...
        protected void FillEditControls(int requestID)
        {
            ...
            if (dtProduct.Rows.Count > 0)
            {
                ...
                int codingid = PHASCOUtility.ConverToNullableInt(dtProduct.Rows[0]["ExpireSchedule"]);
                ...
                if (dtProduct.Rows[0]["image"].ToString() == "1")
                    Image_Photo.ImageUrl = "~/bazar/MyBiztBiz/Pupload/sm_" + dtProduct.Rows[0]["image_name"].ToString();
                if (dtProduct.Rows[0]["image"].ToString() == "0")
                    Image_Photo.ImageUrl = "~/bazar/MyBiztBiz/Pupload/none.jpg";
        ...
        protected void lnkNotConfirm_Click(object sender, EventArgs e)
        {
            DataTable dtProduct = new DataTable();
            if (ProductID > 0)
                dtProduct = da.Tbl_Products_Tra(2, ProductID, "updateStatus", DateTime.Now, TextBox_reason.Text);
        ...
        protected void lnkEdit_Command(object sender, CommandEventArgs e)
        {
            ...
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=1&ProductID=" + ProductID.ToString(), true);
        }
        ...
        {
            ProductID = PHASCOUtility.ConverToNullableInt(e.CommandArgument);
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?Product_Id=" + ProductID.ToString(), true);
        }

        protected void lnkNewProduct_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=1", true);
        }
        ...
        {
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=0&Status=0", true);
        }

        protected void lnkNotConfirmProduct_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=0&Status=2", true);
        }

        protected void lnkConfirmProduct_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=0&Status=1", true);
        }

        protected void lnkExpireProduct_Click(object sender, EventArgs e)
        {
            Response.Redirect("~/Cpanel/Bazar/SubmitProducts.aspx?PageView=0&Status=3", true);
        }
    }
}
