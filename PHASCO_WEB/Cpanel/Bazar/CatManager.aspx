<%@ Page Language="C#" EnableViewState="false" MasterPageFile="~/Template/admin.Master"
    AutoEventWireup="true" CodeBehind="CatManager.aspx.cs" Inherits="BiztBiz.bizpanel.CatManager"
...
<asp:Content ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <table class="style1" style="width: 100%">
        <tr>
            <td style="width: 20%">
                <asp:LinkButton ID="LinkButton_Create_File" runat="server" OnClick="LinkButton_Create_File_Click">Create File</asp:LinkButton>
            </td>
            <td style="width: 80%">
                &nbsp;
            </td>
        ...
        <tr>
            <td colspan="2">
                <asp:GridView ID="grid_Cats" runat="server" AutoGenerateColumns="False" CellPadding="4"
