    ...
    public partial class UserLimitation : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["UserRoleID"]))
                UserRoleID = PHASCOUtility.ConverToNullableInt(Request.QueryString["UserRoleID"]);
        ...
        protected void lnkConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (UserRoleID > 0)
                dtUserRole = da_User.TBL_User_Limitation_Tra(UserRoleID, "update", txtRoleName.Text, PHASCOUtility.ConverToNullableInt(txtProductLimitedCount.Text),
                    PHASCOUtility.ConverToNullableInt(txtProductLimitedDate.Text), PHASCOUtility.ConverToNullableInt(txtRequestLimitedCount.Text),
                    PHASCOUtility.ConverToNullableInt(txtRequestLimitedDate.Text), PHASCOUtility.ConverToNullableInt(txtCompanyLimitedCount.Text), 0);
            else
                dtUserRole = da_User.TBL_User_Limitation_Tra(0, "insert", txtRoleName.Text, PHASCOUtility.ConverToNullableInt(txtProductLimitedCount.Text),
                    PHASCOUtility.ConverToNullableInt(txtProductLimitedDate.Text), PHASCOUtility.ConverToNullableInt(txtRequestLimitedCount.Text),
                    PHASCOUtility.ConverToNullableInt(txtRequestLimitedDate.Text), PHASCOUtility.ConverToNullableInt(txtCompanyLimitedCount.Text), 0);
        ...
        {
            UserRoleID = PHASCOUtility.ConverToNullableInt(e.CommandArgument);
