    ...
    public partial class Coding : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["CodingID"]))
                CodingID = PHASCOUtility.ConverToNullableInt(Request.QueryString["CodingID"]);
        ...
        protected void FillEditControls(int codingID)
        {
            ...
            if (dtCoding.Rows.Count > 0)
            {
                ...
                ddlCodingGroup.SelectedValue = PHASCOUtility.ConverToNullableStringForDDL(dtCoding.Rows[0]["CodingGroupID"]);
            }
        }
        ...
        protected void lnkConfirm_Click(object sender, EventArgs e)
        {
            ...
            if (CodingID > 0)
                dtCoding = da_Coding.TBL_Coding_Tra(CodingID, "update", txtCodingName.Text, 0,
                    PHASCOUtility.ConverToNullableInt(ddlCodingGroup.SelectedValue), PHASCOUtility.ConverToNullableInt(txtCodingValue.Text));
            else
        ...
        {
            CodingID = PHASCOUtility.ConverToNullableInt(e.CommandArgument);
            Response.Redirect("~/Cpanel/Bazar/Coding.aspx?PageView=1&CodingID=" + CodingID.ToString(), true);
        }
        ...
        {
            Response.Redirect("~/Cpanel/Bazar/Coding.aspx?PageView=1", true);
        }
    }
}