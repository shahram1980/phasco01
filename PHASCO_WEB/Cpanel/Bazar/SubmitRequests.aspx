                            ...
                            <asp:GridView ID="grdRequest" runat="server" AutoGenerateColumns="false" Width="500px">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="عملیات" HeaderStyle-HorizontalAlign="Center">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="lnkEdit" runat="server" Text="نمایش" CommandArgument='<%#Eval("RequestID") %>'
            ...
            <asp:View ID="vwRequestDetails" runat="server">
                <table class="style1" dir="rtl">
                    ...
                    <tr>
                       ...
                       <%--                      <asp:UpdateProgress ID="UpdateProgress1" runat="server">
                                <ProgressTemplate>
                                    <asp:Literal ID="Literal00102" runat="server" 
                                        Text="<%$ Resources:Resource, Loading %>" />
                                    ...
                                </ProgressTemplate>
                            </asp:UpdateProgress>--%>
                                          <ajaxToolkit:ToolkitScriptManager ID="ScriptManager1" runat="server" LoadScriptsBeforeUI="False"
                            ...
                            <ajaxToolkit:CascadingDropDown ID="ccdCat1" runat="server" Category="Category" 
                                PromptText="لطفاً انتخاب کنید" ServiceMethod="GetCategory" 
                                ServicePath="~/bazar/Services/BiztBizServices.asmx" 
                                TargetControlID="DropDownList_Cat1" />
                            <asp:DropDownList ID="DropDownList_Cat2" runat="server" CssClass="txtjobsmall">
                            </asp:DropDownList>
                            <ajaxToolkit:CascadingDropDown ID="ccdCat2" runat="server" 
                                Category="SubCategory" ParentControlID="DropDownList_Cat1" 
                                PromptText="لطفاً انتخاب کنید" ServiceMethod="GetSubCategory" 
                                ServicePath="~/bazar/Services/BiztBizServices.asmx" 
                                TargetControlID="DropDownList_Cat2" />
                            <asp:DropDownList ID="DropDownList_Cat3" runat="server" CssClass="txtjobsmall">
                            </asp:DropDownList>
                            <ajaxToolkit:CascadingDropDown ID="ccdCat3" runat="server" 
                                Category="Sub2Category" ParentControlID="DropDownList_Cat2" 
                                PromptText="لطفاً انتخاب کنید" ServiceMethod="GetSub2Category" 
                                ServicePath="~/bazar/Services/BiztBizServices.asmx" 
                                TargetControlID="DropDownList_Cat3" />
