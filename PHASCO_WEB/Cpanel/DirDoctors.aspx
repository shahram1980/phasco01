<%@ Page Title="" Language="C#" MasterPageFile="~/Template/admin.Master" AutoEventWireup="true" CodeBehind="DirDoctors.aspx.cs" Inherits="PHASCO_WEB.DirDoctors" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td dir="rtl" style="width: 100%; height: 20px;">
                                                    <a href="DirDoctors.aspx?mode=3">اضافه و ويرايش پزشک</a>|
                                                    <a href="DirDoctors.aspx?mode=4">ويرايش</a>|<a href="DirDoctors.aspx?mode=5"> پزشک های
                                                        جدید<br /></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                            ...
                                                            <td align="right">
                                                                <asp:DataGrid ID="Grd_region" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                                    ...
                                                                    <Columns>
                                                                        ...
                                                                        <asp:ButtonColumn CommandName="Delete" HeaderText="حذف" Text="حذف">
                                                                        </asp:ButtonColumn>
                                                                    </Columns>
                                                                </asp:DataGrid>
                                                            </td>
                                                                            ...
                                                                            <table border="0" style="width: 100%">
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                        نام پزشک</td>
                                                                                    <td align="right">
                                                                                        <asp:TextBox ID="txt_name_ins" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small"></asp:TextBox>
                                                                                        &nbsp; DR&nbsp;
                                                                                        <asp:TextBox ID="txt_nameEN_ins" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                        &nbsp;</td>
                                                                                    <td align="right">
                                                                                        <asp:DropDownList ID="Drop_estar_Ins" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                        <asp:TextBox ID="txt_Address" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small" Width="90%"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                        <asp:TextBox ID="Txt_foods" runat="server" TextMode="MultiLine" Font-Names="Tahoma"
                                                                                            Font-Size="X-Small" Height="123px" Width="412px"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                    ...
                                                                                    <td align="right" dir="ltr">
                                                                                        <asp:TextBox ID="Txt_tel" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                        ...
                                                                                        Specialization</span></span></td>
                                                                                    <td align="right" dir="ltr">
                                                                                        <asp:TextBox ID="Txt_foodsEN" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small" Height="123px" Width="339px" TextMode="MultiLine" ></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                    ...
                                                                                    <td align="right">
                                                                                        ...
                                                                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                                                                                            ...
                                                                                            ErrorMessage="ايميل نامعتیر است" ForeColor="DarkRed" 
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td align="right">
                                                                                        <asp:DropDownList ID="Drop_Expire" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="right" width="80">
                                                                                        &nbsp;</td>
                                                                                    <td align="right">
                                                                                        <asp:TextBox ID="txt_Time" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                        <asp:TextBox ID="txt_TimeEN" runat="server" Font-Names="Tahoma" 
                                                                                            Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                            ...
                                                                            <table border="0" style="width: 100%">
                                                                                ...
                                                                                <tr>
                                                                                    <td align="left">
                                                                                        کد :</td>
                                                                                    <td align="right">
                                                                                        <asp:TextBox ID="TextBox_Serach_Code" runat="server"></asp:TextBox>
                                                                                    </td>
                                                                                </tr>
                                                                            </table>
                                                                        </div>
                                                    ...
                                                    <tr>
                                                                            ...
                                                                            <div>
                                                                                <table border="0" style="width: 100%">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td align="right">
                                                                                            <asp:TextBox ID="txt_Ename_edt" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small"></asp:TextBox>
                                                                                        </td>
                                                                                        <td align="right">
                                                                                            تعداد ستاره
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="right">
                                                                                            DR Name</td>
                                                                                        <td align="right" dir="ltr">
                                                                                            <asp:TextBox ID="txt_EnameEN_edt" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small" Height="22px"></asp:TextBox>
                                                                                        </td>
                                                                                        <td align="right">
                                                                                        </td>
                                                                                        <td align="right">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="right">
                                                                                            <span ID="result_box0" class="short_text" lang="en"><span class="hps">
                                                                                            Specialization</span></span></td>
                                                                                        <td align="right" colspan="3" dir="ltr">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td align="right" style="height: 15px">
                                                                                            &nbsp;</td>
                                                                                        <td align="right" colspan="3" style="height: 15px">
                                                                                            <asp:TextBox ID="Txt_EtimeEN" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                            <asp:TextBox ID="Txt_Etime" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                            <asp:TextBox ID="txt_Emagaer" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                            <asp:TextBox ID="txt_EmagaerEN" runat="server" Font-Names="Tahoma" 
                                                                                                Font-Size="X-Small" Visible="False"></asp:TextBox>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                                                                    ...
                                                                                                                                    <table border="0" style="width: 100%">
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" style="width: 100%">
                                                                                                                                                <img src='../phascoupfile/Dir_Co_Gallery/s<%# image_Check_dir(Eval("id").ToString())%>'>
                                                                                                                                            </td>
                                                                                                                                        </tr>
                                                                                                                                        <tr>
                                                                                                                                            <td align="center" style="width: 100%">
                                                        ...
                                                        <td valign="top" width="400">
                                                            <asp:DataGrid ID="Grid_Rest" runat="Server" AllowPaging="True" AutoGenerateColumns="False"
                                                                BackColor="White" BackImageUrl="~/images/bg-bo-1.jpg" 
                                                                ...
                                                                PagerStyle-BorderColor="beige" PagerStyle-Mode="NumericPages" 
                                                            ...
                                                            <ItemTemplate>
                                                                <table border="0" style="width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td id="TD4" runat="server" align="right" colspan="3">
                                                                            <%#Eval("tel")%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td runat="server" align="right" colspan="3" style="height: 15px" id="Td5">
                                                                            <%#Eval("EMail")%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        ...
                                                                        <td runat="server" align="right" colspan="3" id="Td6">
                                                                            <%#Eval("WebSite")%>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" colspan="3">
                                                                            <a href="DirDoctors.aspx?opaid=<%#Eval("autoid")%>&mode=5">تائید</a>
                                                                            <a href="DirDoctors.aspx?opdid=<%#Eval("autoid")%>&mode=5">حذف</a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="center" colspan="4" style="height: 15px">
