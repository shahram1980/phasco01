<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="uploaderfile.aspx.cs" Inherits="NewFifa.Admin.VideoManage.uploaderfile" %>
...
<head runat="server">
    <title></title>
    <link href="/Admin/video/CSS/ThemeBlue.css" rel="Stylesheet" type="text/css" />
                                    ...
                                    <td>
                                        <div id="dvUploader">
                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                <tr>
                                                    <td style="width: 50%">
                                                        <iframe id="uploadFrame" runat="server" frameborder="0" height="25" width="200" scrolling="no" src="UploadEngine.aspx">
                                                        </iframe>
                                                    </td>
                                                    <td>
