...
using System.IO;
using System.Data;
using NewFifaBusinessLogics;

namespace NewFifa.Admin.VideoManage
{
    public partial class uploaderfile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs args)
        {
            if (!this.IsPostBack)
            {
                ...
                LoadUploadedFiles(ref gvNewFiles);
                 this.Session["Uploadfv"] = Request.QueryString["fv"].ToString() ;
                 this.Session["UploadvId"] = Request.QueryString["vId"].ToString();
            }
        }
