<%@ Page Language="C#" MasterPageFile="~/Template/admin.Master" AutoEventWireup="true"
    CodeBehind="Dir_CoMain.aspx.cs" Inherits="PHASCO_WEB.Cpanel.Dir_CoMain" %>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                            <tr>
                                                <td dir="rtl" style="width: 100%; height: 20px;">
                                                    <a href="Dir_CoMain.aspx?mode=3">اضافه و ويرايش شرکت</a>| <a href="Dir_CoMain.aspx?mode=4">
                                                        ويرايش</a>|<a href="Dir_CoMain.aspx?mode=5"> شرکت های جدید<br />
                                                        </a>
                                                </td>
                                            </tr>
                                            <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td valign="top" width="400">
                                                            <asp:DataGrid ID="Grid_Rest" runat="Server" AllowPaging="True" AutoGenerateColumns="False"
                                                                ...
                                                                PagerStyle-BorderColor="beige" PagerStyle-Mode="NumericPages" PageSize="50" ShowHeader="False"
                                                                Width="300px">
                                                                <FooterStyle BackColor="#CCCCCC" />
                                                                <SelectedItemStyle BackColor="#000099" Font-Bold="True" ForeColor="White" />
                                                            ...
                                                            <ItemTemplate>
                                                                <table border="0" style="width: 100%">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td align="right" colspan="3">
                                                                            <a href="Dir_CoMain.aspx?opaid=<%#Eval("autoid")%>&mode=5">تائید</a> <a href="Dir_CoMain.aspx?opdid=<%#Eval("autoid")%>&mode=5">
                                                                                حذف</a>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
