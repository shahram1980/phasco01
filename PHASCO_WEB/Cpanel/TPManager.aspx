<%@ Page Title="" Language="C#" MasterPageFile="~/Template/admin.Master" AutoEventWireup="true" CodeBehind="TPManager.aspx.cs" Inherits="PHASCO_WEB.Cpanel.TPManager" %>
...
<script language="C#" runat="server">
    ...
    public string Banner_View(int Allow, int id)
    {
        ...
        if (Allow == 1)
        // image_Rollover = "<a href='#' class='thumbnail' ><img src='Images/images.gif' border='0' /><span><img src='../phascoupfile/FolderImages/mperis_" + id.ToString() + ".jpg' /><br /></span></a>";
        {
            image_Rollover = " <div>";
            image_Rollover = image_Rollover + "<a href='../phascoupfile/FolderImages/mperis_" + id.ToString() + ".jpg' class='highslide' onclick='return hs.expand(this)'><img src='Images/images.gif' alt='Highslide JS'	title='Click to enlarge'></a>";
                ...
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="width: 90%; padding: 5px;">
                            <asp:Label ID="Lbl_ALARM" runat="server" Font-Names="Tahoma" ForeColor="Red"></asp:Label>
                        </td>
                    </tr>
                </table>
            </td>
            ...
            <td dir="rtl" style="width: 80%" valign="top">
                <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                    ...
                    <tr>
                        ...
                        <td style="width: 80%; height: 20px;" valign="top" align="right">
                            <asp:CheckBox ID="CheckBox_Allow_wview" runat="server" Font-Names="Tahoma" 
                    ...
                    <tr>
                        ...
                        <td style="width: 80%" valign="top" align="right">
                            <asp:FileUpload ID="FileUpload_Banner" runat="server" Font-Names="Tahoma" 
                                Font-Size="X-Small" Enabled="False" />&nbsp;
                            <asp:LinkButton ID="LinkButton_delete_Image" runat="server" Font-Size="XX-Small"
                                ForeColor="Red" OnClick="LinkButton_delete_Image_Click" Visible="False" 
                                Enabled="False">حذف تصویر</asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width: 80%; height: 37px;" valign="top" align="right">
                            ...
                            <asp:Button ID="Button_Edit" runat="server" Font-Names="Tahoma" Font-Size="X-Small"
                                OnClick="Button_Edit_Click" Text="ويرايش" Visible="False" />
                        </td>
                    </tr>
                    <tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" style="width: 100%">
                                <tr>
                                    <td style="width: 30%" valign="top">
                                        <asp:LinkButton ID="LinkButton_Change_Mode" runat="server" OnClick="LinkButton_Change_Mode_click">تغییر حالت منو</asp:LinkButton>
                                    </td>
                                    <td style="width: 70%" valign="top">
                                        <asp:LinkButton ID="LinkButton_Back_To_Parent" runat="server" OnClick="LinkButton_Back_To_Parent_Click"
                                            Visible="False">برگشت به مرحله قبل</asp:LinkButton>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="width: 30%" valign="top">
                                        <asp:Menu ID="Menu1" DataSourceID="xmlDataSource" runat="server" DynamicHorizontalOffset="2"
                                            StaticDisplayLevels="1" DynamicEnableDefaultPopOutImage="False" StaticPopOutImageUrl="~/Cpanel/Images/Menu_PopUp_f.gif"
                                            DynamicPopOutImageUrl="~/Cpanel/Images/Menu_PopUp_f.gif" Height="23px" MaximumDynamicDisplayLevels="9">
                                            <DataBindings>
                                    ...
                                    <td style="width: 70%" valign="top">
                                        <asp:GridView ID="GRD_List" runat="server" AutoGenerateColumns="False" CellPadding="4"
                                            ...
                                            <Columns>
                                                <asp:BoundField DataField="text" HeaderImageUrl="~/Cpanel/Images/folder.png" HeaderText="عنوان">
                                                    <ItemStyle HorizontalAlign="Right" VerticalAlign="Top" Width="40%" />
                                                    <HeaderStyle HorizontalAlign="Right" />
                                                </asp:BoundField>
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/Subject.png" HeaderText="زیرگروه">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/Text.png" HeaderText="متن">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/Image.png" HeaderText="گالری">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/attach.png" HeaderText="سند">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/Permission.png" HeaderText="تنظیمات">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/Edit.png" HeaderText="حذف | ویرایش">
                                                    <ItemTemplate>
                                            ...
                                            ويرايش
                                                        ...
                                                        <asp:LinkButton ID="LinkButton_delete" OnClientClick="return confirm('در صورت حذف تمامی زیر منوها و مطالب آن حذف خواهد شد')"
                                                            CommandArgument='<%#DataBinder.Eval(Container,"DataItem.MenuID","{0}") %>' runat="server"
                                            ...
                                            حذف
                                                ...
                                                <asp:TemplateField HeaderImageUrl="~/Cpanel/Images/icon_users_32px.gif" HeaderText="وضعیت">
                                                    <ItemTemplate>
                                                            ...
                                                            <table border="0" style="width: 100%">
                                                                <tr>
                                                                    <td align="center" style="width: 100%">
                                                                        <div>
                                                                            <%--<a href="../phascoupfile/imgtpme/b<%# Eval("small")%>" class="highslide" onclick="return hs.expand(this)">--%>
                                                                                <img src="../phascoupfile/imgtpme/s<%# Eval("small")%>" alt="Highslide JS" title="Click to enlarge" />
                                                                           <%-- </a>--%>
                                                                        </div>
                                                                    </td>
                                                                </tr>
                                                        ...
                                                        <tr>
                                                            <td align="right" width="90%">
                                                                <asp:TextBox ID="Text_Comment" runat="server" Font-Names="Tahoma" Font-Size="X-Small"
                                                                    Height="55px" TextMode="MultiLine" Width="286px"></asp:TextBox>
                                                            </td>
                                                            <td align="right" width="10%">
                                                                <span style="font-size: 10pt; font-family: Tahoma">عنوان</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" width="90%">
                                                                <asp:FileUpload ID="FileUpload_DOc" runat="server" />
                                                            </td>
                                                            <td align="right" width="10%">
                                                                <span style="font-size: 10pt; font-family: Tahoma">فايل</span>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right" width="90%">
                                        ...
                                        <tr>
                                            <td align="right" style="width: 50%" valign="top">
                                                <asp:Button ID="Button_AddUser" runat="server" Font-Names="Tahoma" Font-Size="X-Small"
                                                    OnClick="Button_Button_AddUser" Text="اضافه کردن" />
                                            </td>
                                            <td align="right" style="width: 50%" valign="top">
                                            </td>
                                        </tr>
