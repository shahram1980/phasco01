...
{
    public partial class EnabledResumes : System.Web.UI.Page
    {
        ...
        protected void Getresumes()
        {
            if (Request["id"] == null)
            {
                //Don't worry ! I just showing some greasy information about resumes :
                int UserID = UserOnline.id();
                TBL_Job_Resume Enabled_Resume_Summary = new TBL_Job_Resume();
                DataTable dt;
                dt = Enabled_Resume_Summary.TBL_Job_Resume_SP("Enabled_resumes_summary", UserID, 1);
            ...
            else if (Request["id"] != null)
            {
                ...
                Label_ExpireTime3.Text = dt.Rows[0]["ExpirationTime"].ToString();
                ...
                //
                HyperLink_Enabled_to_complete.NavigateUrl = "~/job/Complete_resume.aspx?ResumeID=" + id + "&status=insert&from=EnabledResumes";
        ...
        public string GetfarsiDate(object date)
        {
            ...
            //temp = DateTime.Parse(date.ToString());
            //PersianDate Pdate = PersianDate.GetPersianDate(temp);
        ...
        {
            return "~/Job/EnabledResumes.aspx?id=" + id.ToString() + "&CategoryID=" + CategoryID.ToString();
        }
        ...
        protected void Button_update_resume_Click(object sender, EventArgs e)
        {
            ...
            dt = update_resume.TBL_Job_Resume_SP("Update_Resume", ResumeSubject, NationalNum, serviceStatus, Phone, mobile, JobStatus, EducationStatus, UserID, CategoryID, CategoryID_Sub, Explantion, id, CoOperate_Condition, pro_abilities, Requested_Wage);
