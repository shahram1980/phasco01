        ...
        a.extend(a.fn, { fileUpload: function (b) {
            if (flashVer >= 9) {
                a(this).each(function () {
                    document.getElementById("ImageButton_Nexttocomplete").style.visibility = 'hidden';
                    document.getElementById("txtNameVideo").style.visibility = 'hidden';
                    ...
                    if (settings.onInit() !== false) {
                        ...
                        if (j.data.action(j, h, i) !== false) {
                            var k = Math.round(i.size / 1024 * 100) * 0.01; var l = "KB";
                            if (k > 1000) { k = Math.round(k * 0.001 * 100) * 0.01; l = "MB" } var m = k.toString().split(".");
                            if (m.length > 1) { k = m[0] + "." + m[1].substr(0, 2) } else { k = m[0] }
                            if (i.name.length > 20) { fileName = i.name.substr(0, 20) + "..." }
                    ...
                    function (j, h, i, k) {
                     ...
                     function () { a("#" + a(this).attr("id") + h).remove() })
                        }
                      ...
                      function () { a("#" + a(this).attr("id") + "Queue").empty() })
                        }
                    });
                    ...
                    a(this).bind("rfuProgress", { action: settings.onProgress, toDisplay: settings.displayData }, function (j, h, i, k) {
                        if (j.data.action(j, h, i, k) !== false) {
                            ...
                            document.getElementById("ImageButton_Nexttocomplete").style.visibility = 'visible';
                            document.getElementById("div_Alarm").style.visibility = 'hidden';
                        }
                    });
