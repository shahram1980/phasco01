                                            ...
                                            <asp:Repeater ID="repRequestsDetail" runat="server">
                                                <ItemTemplate>
                                                    <div style="float: right; width: 500px;">
                                                        نام کالای درخواستی : <span style="font: 18px 'b koodak',arial; color: #02799b; font-weight: bold">
                                                            <%#Eval("ProductName")%>
                                                        </span>
                                                        <br />
                            ...
                            <table cellpadding="0" cellspacing="0" style="width: 220px; float: left">
                                <tr>
                                    ...
                                    <td style="background: transparent url('images/new-fame-2-top-mid.jpg') repeat-x scroll center top;
                                        ...
                                        <span class="frame-title">اطلاعات درخواست دهنده</span>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td id="tdUserInfo" runat="server" visible="false" style="background: #f9f9f9; color: #3333ff;
                                        text-align: right; padding: 0 5px 5px 0; line-height: 18px; border-bottom: 2px #ccc solid">
                                        درخواست دهنده :
                                    ...
                                    <td id="tdNotUserInfo" runat="server" visible="false" style="background: #f9f9f9;
                                        color: #3333ff; text-align: right; padding: 5px; line-height: 18px; border-bottom: 2px #ccc solid">
                                        برای نمایش اطلاعات درخواست دهنده ابتدا باید <a href="register.aspx">عضو سایت</a>
                                        شوید.
                                        <%-- <br />
