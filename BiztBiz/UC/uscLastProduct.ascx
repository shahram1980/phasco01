...
<table class="h-last-table" cellpadding="0" cellspacing="0">
    <tr>
        <td style="padding-right:1px;">
            <img alt="" height="54" src="<%= ImgSiteFolder %>bg-title-last.jpg" width="863" />
        </td>
    </tr>
    <tr>
                                ...
                                <AlternatingItemTemplate>
                                    <div>
                                        <table cellpadding="0" cellspacing="0" style="width: 400px">
                                            <tr class="h-last-table-item2-color1">
                                                <td class="h-last-table-item2-color2-icon">
                                                    <img alt="" height="14" src="<%= ImgSiteFolder %>icon-star.jpg" width="14" />
                                                </td>
                                                <td class="h-last-table-item2-color2">
                                                    <a href='Productdetails.aspx?ProductID=<%#Eval("id")%>&CategoryID=<%#Eval("Group_id")%>&Level=2&SearchSection=1'>
                                                        <%#Eval("Produc_Name")%></a>
                                                </td>
                                                <td class="h-last-table-item3-color2">
                                    ...
                                    <div>
                                        <table cellpadding="0" cellspacing="0" style="width: 400px">
                                            <tr class="h-last-table-item2-color3">
                                                <td class="h-last-table-item2-color4-icon">
                                                    <img alt="" height="15" src="<%= ImgSiteFolder %>icon-star1.jpg" width="16" />
                                                </td>
                                                <td class="h-last-table-item2-color4">
                                                    <a href='Productdetails.aspx?ProductID=<%#Eval("id")%>&CategoryID=<%#Eval("Group_id")%>&Level=2&SearchSection=1'>
                                                        <%#Eval("Produc_Name")%></a>
                                                </td>
                                                <td class="h-last-table-item3-color2">
                                    ...
                                    <div>
                                        <table cellpadding="0" cellspacing="0" style="width: 400px">
                                            <tr class="h-last-table-item1-color1">
                                                <td class="h-last-table-item1-color2-icon">
                                                    <img alt="" height="17" src="<%= ImgSiteFolder %>icon-basket.jpg" width="19" />
                                                </td>
                                                <td class="h-last-table-item1-color2">
                                    ...
                                    <div>
                                        <table cellpadding="0" cellspacing="0" style="width: 400px">
                                            <tr class="h-last-table-item1-color3">
                                                <td class="h-last-table-item1-color3-icon">
                                                    <img alt="" height="18" src="<%= ImgSiteFolder %>icon-basket1.jpg" width="19" />
                                                </td>
                                                <td class="h-last-table-item1-color3">
                                                    <a href='Request.aspx?RequestID=<%#Eval("RequestID")%>&CategoryID=<%#Eval("Group_id")%>&Level=2&SearchSection=2'>
                                                        <%#Eval("ProductName")%></a>
                                                </td>
                                                <td class="h-last-table-item3-color2">
    ...
    <tr>
        <td>
            <img alt="" height="14" src="<%= ImgSiteFolder %>bg-title-last-down.jpg" width="862" />
        </td>
    </tr>
</table>
