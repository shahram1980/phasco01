<%@ Page Title="" Language="C#" MasterPageFile="~/Template/CompanyDeteil.Master"
    AutoEventWireup="true" CodeBehind="CompanyBranch.aspx.cs" Inherits="BiztBiz.C_p.CompanyBranch" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolderContent" runat="server">
    <table cellpadding="0" cellspacing="0" style="width: 1000px; height: 45px; margin: 10px">
        <tr>
            ...
            <td style="background: transparent url('../images/pi-pro-fram-2-mid.jpg') repeat-x scroll center top;
                text-align: right">
                <img alt="" height="26" src="../images/br-ico-map.jpg" style="vertical-align: middle;"
                    width="26" />
                <span style="color: #006699">شما الان اینجا هستید:</span> <span style="font-weight: normal;
                    color: #0099cc">ایران پروبیز</span>
                <img alt="" height="16" src="../images/br-ico-bul.jpg" style="vertical-align: middle;"
                    width="11" />
                <span style="font-weight: normal; color: #0099cc">ایران پروبیز</span>
                <img alt="" height="16" src="../images/br-ico-bul.jpg" style="vertical-align: middle;"
                    width="11" />
                <span style="font-weight: normal; color: #0099cc">ایران پروبیز</span>
                <img alt="" height="16" src="../images/br-ico-bul.jpg" style="vertical-align: middle;"
            ...
            <td>
                                ...
                                <tr>
                                    ...
                                    <td style="vertical-align: top">
                                        <div style="padding: 5px; float: right; text-align: justify">
                                            ردیابی و موقعیت یابی وسایل نقلیه و اشخاص (AVL)
                                            <br />
                                            مشاهده موقعیت وسایل نقلیه بر روی نقشه از طریق
                                            <br />
                                            - اینترنت
                                            <br />
                                            - گزارشات مختلف جهت بررسی کارایی رانندگان و وسایل نقلیه
                                            <br />
                                            - دستگاه های GPS ارزان و با کیفیت همراه با گارانتی شرکت فرجاد سیستم پرداز مشاهده
                                            موقعیت وسایل نقلیه بر روی نقشه از طریق
                                            <br />
                                            - اینترنت
                                            <br />
                                            - گزارشات مختلف جهت بررسی کارایی رانندگان و وسایل نقلیه
                                            <br />
                                            - دستگاه های GPS ارزان و با کیفیت همراه با گارانتی شرکت فرجاد سیستم پرداز
                                        </div>
                ...
                <table cellpadding="0" cellspacing="0" style="width: 100%; float: left; margin-top: 10px">
                    ...
                    <tr>
                        ...
                        <td style="background: #f9f9f9; color: #3333ff; text-align: right; padding-right: 5px;
                            border-bottom: 2px #ccc solid">
                            <span style="float: right; margin: 20px; color: #999; font-weight: bold">دستعه بندی
                                محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
                                    دستعه بندی محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
                                        دستعه بندی محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
                                            دستعه بندی محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
                                                دستعه بندی محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
                                                    دستعه بندی محصولات</span> <span style="float: right; margin: 20px; color: #999; font-weight: bold">
    ...
    <table>
        <tr>
            <td>
                <asp:Repeater ID="repCompanyBranchDetails" runat="server">
                    <ItemTemplate>
                        نام شعبه :
                        <%#Eval("BranchName")%>
                        <br />
        ...
        <tr>
            <td>
                ...
                <asp:Repeater ID="repCompanyBranchList" runat="server">
                    <ItemTemplate>
                        <tr>
                            <td>
                                <a href='CompanyBranch.aspx?CompanyBranchID=<%#Eval("CompanyBranchID")%>'>
                                    <%#Eval("BranchName")%>
                                </a>
                            </td>
                            <td>
