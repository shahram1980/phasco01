    ...
    public partial class Company_Branch : BasePage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["CompanyBranchID"]))
                CompanyBranchID = Utility.ConverToNullableInt(Request.QueryString["CompanyBranchID"]);
        ...
        {
            CompanyBranchID = Utility.ConverToNullableInt(e.CommandArgument);
            Response.Redirect("~/MyBiztBiz/Company_Branch.aspx?PageView=1&CompanyBranchID=" + CompanyBranchID.ToString(), true);
        }
        ...
        {
            Response.Redirect("~/MyBiztBiz/Company_Branch.aspx?PageView=1", true);
        }
