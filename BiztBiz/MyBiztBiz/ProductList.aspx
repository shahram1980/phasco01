<%@ Page Title="" Language="C#" MasterPageFile="~/Template/Office.Master" AutoEventWireup="true"
    CodeBehind="ProductList.aspx.cs" Inherits="BiztBiz.MyBiztBiz.ProductList" %>
                    ...
                    <table border="0" id="table1" dir="ltr" cellpadding="0" style="border-collapse: collapse;
                        ...
                        <tr>
                            <td align="left" width="30%" style="vertical-align: middle;">
                                <a href="ProductPicture.aspx?Product_Id=<%# Eval("Id") %>" target="_parent">
                                    <asp:Literal Text="<%$ Resources:Resource, ProductPicture %>" runat="server" ID="Literal3" />
                                </a>| <a href="EditProduct.aspx?id=<%# Eval("Id") %>" target="_parent">
