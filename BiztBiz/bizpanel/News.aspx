            ...
            <table id="table69" border="0" dir="rtl" width="700">
                ...
                <tr>
                    <td style="height: 22px; width: 77px;">
                        <font face="Tahoma" size="2"><span lang="fa">&nbsp;نظر خواهی</span></font>
                    </td>
                        ...
                        <font face="Tahoma" size="2">
                            <asp:DataGrid ID="Grid_editList" runat="Server" AllowPaging="True" AutoGenerateColumns="False"
                                            ...
                                            <table id="table1" border="0" dir="rtl" style="border-collapse: collapse" width="95%">
                                                <tr>
                                                    <td align="right" dir="rtl" style="height: 59px" valign="top">
                                                        <%# Eval("title")%>
                                                        <b><font size="1" color="#ff0000">(<%# set_Lang(Eval("lang").ToString())%>) </font>
                                                        </b>
                                                        <br />
                                                        <%# Eval("Farsi_Month")%>
                                                        <%# Eval("Farsi_Daye")%>
                                                        ...
                                                        <asp:LinkButton ID="Link_Delete" runat="server" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.id","{0}") %>'
                                                            OnCommand="Link_Delete_Command" OnClientClick="return confirm('آیا برای حذف اطمینان دارید ');">&#1581;&#1584;&#1601;</asp:LinkButton>]
                                                        [<asp:LinkButton ID="Link_Edit_News" runat="server" CommandArgument='<%#DataBinder.Eval(Container,"DataItem.id","{0}") %>'
                                ...
                                <PagerStyle BackColor="#2461BF" BorderColor="Red" BorderStyle="Solid" BorderWidth="1px"
                                    Font-Size="Medium" ForeColor="White" HorizontalAlign="Center" Position="TopAndBottom"
