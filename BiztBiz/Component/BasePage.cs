...
namespace BiztBiz
{
    public class BasePage : System.Web.UI.Page
    {
        ...
        {
            get { staticSiteFolder = ResolveUrl("~") + "images/"; return staticSiteFolder; }
        }

        private string variantSiteFolder;
        public string VariantSiteFolder
        {
            get { variantSiteFolder = ResolveUrl("~") + "images/" + MultiLanguage.GetCurrentDirection().ToString() + "/"; return variantSiteFolder; }
        }
        ...
        public string ImgSiteFolder
        {
            get
            {
                imgSiteFolder = ResolveUrl("~") + "images/site/";
    ...
    public class BaseMasterPage : System.Web.UI.MasterPage
    {
        ...
        public string VariantSiteFolder
        {
            get
            {
                variantSiteFolder = ResolveUrl("~") + "images/" +
