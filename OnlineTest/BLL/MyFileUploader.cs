...
namespace OnlineTest.BLL
{
    ...
    {
        public static string SaveFile(FileUpload fileUpload, string Folder_, int id_,  HttpServerUtility Server)
        {
            try
            {
                string file_name = "";
        ...
        public static int SaveFile_MyFileName(FileUpload fileUpload, string Folder_, string filename,  HttpServerUtility Server)
        {
            try
            {
                string file_name = "";
