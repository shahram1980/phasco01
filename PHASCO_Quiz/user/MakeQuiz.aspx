<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Template/Site_user.Master" CodeBehind="MakeQuiz.aspx.cs" Inherits="OnlineTest.user.MakeQuiz" %>
...
<asp:Content ID="content2" ContentPlaceHolderID="Plc" runat="server">
  ...
  <td style="direction:rtl; width:200px;">
            ...
            Text="عنوان آزمون را مشخص کنید"  ValidationGroup="Insert" Display="Dynamic" 
  ...
  <td style="direction:rtl; width:200px;">
      <asp:DropDownList ID="DropDownList_Degree" runat="server"  DataTextField="DegreeName" Width="200px"
      AppendDataBoundItems="true"   DataValueField="id">
  ...
  <td style="direction:rtl; width:200px;">
      <asp:DropDownList ID="DropDownList_group" runat="server"  DataTextField="GroupName"  AutoPostBack="true"
      AppendDataBoundItems="true"   DataValueField="id"  Width="200px"
  ...
  <td style="direction:rtl; width:200px;">
      <asp:DropDownList ID="DropDownList_Fields" runat="server"  DataTextField="FieldName"  AutoPostBack="true"
      DataValueField="id"  Width="200px"
          onselectedindexchanged="DropDownList_Fields_SelectedIndexChanged">
  ...
  <td style="direction:rtl; width:200px;">
            ...
            Text="رشته را مشخص کنید"  ValidationGroup="Insert" Display="Dynamic"  
            ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
    </td>
    </tr>
    ...
    <asp:Repeater ID="Repeater_lessons" runat="server" 
        onitemcommand="Repeater_lessons_ItemCommand">
    <ItemTemplate>
    ...
    &nbsp;&nbsp;
    (&nbsp;<%#Eval("LessonCount")%>&nbsp;)<asp:HiddenField ID="HiddenField_LessonID" runat="server"  Value='<%#Eval("id") %>'/>
        ...
        <td  style="width:350px;">
            ...
            <asp:RangeValidator ID="RangeValidator1" runat="server"   ControlToValidate="TextBox_LessonCount"  ValidationGroup="Insert" 
             Display="Dynamic"  Type="Integer"  MinimumValue="0" MaximumValue='<%#Eval("LessonCount")%>' Text="اصلاح شود"
...
<asp:RadioButton ID="RadioButton_standard" runat="server" Checked="true"   AutoPostBack="true"
        Text="استاندارد" GroupName="TimeOptions" 
        oncheckedchanged="RadioButton_standard_CheckedChanged"></asp:RadioButton>
...
<td  id="Td_TimeToAnswer" runat="server" visible="false">
    ...
    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server"  ControlToValidate="TextBox_TimeToAnswer"
     Text="*" Display="Dynamic" ValidationGroup="Insert" 
    ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
    
    <asp:RangeValidator ID="RangeValidator2" runat="server"  Text="حداقل یک دقیقه" 
     ErrorMessage="RangeValidator"  ValidationGroup="Insert" Display="Dynamic"  Type="Integer"
       ControlToValidate="TextBox_TimeToAnswer" MinimumValue="1" MaximumValue="1000"
      ></asp:RangeValidator>
  ...
  <td>
      <asp:ImageButton ID="ImageButton_MakeQuiz" runat="server"   onclick="Button_MakeQuiz_Click"
       ImageUrl="~/Images2/1066.png" Width="58" Height="70"
       ToolTip="ایجاد آزمون" ValidationGroup="Insert"/>
