...
namespace OnlineTest.BLL
{
    ...
    {
        public void Get_farsi_calendar()
        {
        ...
        //public string GetFarsiYear(object date)
        //{
        //    DateTime ReceiptDate = DateTime.Parse(date.ToString());
        //    PersianDate pd = new PersianDate(ReceiptDate);
        //    return (pd.Year % 100).ToString();
        //}
        ////
        //public string GetFarsiYear(DateTime date)
        //{
