<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ManageLessons.aspx.cs"  MasterPageFile="~/Template/Phasco01.Master"  Inherits="OnlineTest.Admin.ManageLessons" %>
  ...
  <asp:MultiView ID="MultiView1" runat="server">
    ...
    نام درس
        ...
        <td style="width:20%;">
            ...
            Text="نام درس را مشخص کنید"  ValidationGroup="Insert" Display="Dynamic" 
    ...
    <td style="width:20%;">
        ...
        <td style="width:60%;">
            ...
            <asp:DropDownList  Width="200px" ID="DropDownList_LessonType" runat="server" DataTextField="LessonType" DataValueField="id" AppendDataBoundItems="true">
    ...
    ضریب درس
     ...
     <asp:TextBox ID="TextBox_LessonCoefficient" runat="server" MaxLength="1"  Width="200px"></asp:TextBox>
        ...
        <td style="width:20%;">
            ...
            Text="ضریب درس را مشخص کنید"  ValidationGroup="Insert" Display="Dynamic" 
            ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
...
<%--    
    ...
    زمان پاسخگویی به هر سوال  
     ...
     <asp:TextBox ID="TextBox_TimeToAnswer" runat="server" MaxLength="3"  Width="200px"></asp:TextBox>
        ...
        <td style="width:20%;">
            ...
            Text=" حداقل 30 و حداکثر 180ثانیه، زمان پاسخگویی مجاز نیست"  ValidationGroup="Insert" Display="Dynamic"  Type="Integer"
             MaximumValue="180"   MinimumValue="30"
             ErrorMessage="RangeValidator"></asp:RangeValidator>
    </td>
  ...
  <%--  Lessondescription                 Lessondescription                 Lessondescription          --%> 
    ...
    <tr>
        ...
        <td style="width:60%; text-align:center;">
                   <asp:Button ID="ButtonAdd_Lesson" runat="server" Text="افزودن درس"  
            ValidationGroup="Insert" onclick="ButtonAdd_Lesson_Click"
           />
    </td>
        <td style="width:20%;">
    ...
    <br />
    <br />
          <asp:GridView ID="GridView_Lesson" runat="server" AutoGenerateColumns="False" CellPadding="3"  CssClass="grd"
    ...
    نام درس
        ...
        <td style="width:20%;">
            ...
            Text="نام درس را مشخص کنید"  ValidationGroup="edit" Display="Dynamic" 
            ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
    </td>
    ...
    <td style="width:20%;">
        ...
        <td style="width:60%;">
            <asp:DropDownList ID="DropDownList_LessonType_E"  Width="200px" runat="server" DataTextField="LessonType" DataValueField="id" AppendDataBoundItems="true">
            <asp:ListItem Text="--انتخاب کنید--"></asp:ListItem>
            </asp:DropDownList>
    </td>
        <td style="width:20%;">
    ...
    ضریب درس
     ...
     <asp:TextBox ID="TextBox_LessonCoefficient_E" runat="server" MaxLength="1" Width="200px"></asp:TextBox>
        ...
        <td style="width:20%;">
            ...
            Text="ضریب درس را مشخص کنید"  ValidationGroup="edit" Display="Dynamic" 
            ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
    ...
    زمان پاسخگویی به هر سوال  
     ...
     <asp:TextBox ID="TextBox_TimeToAnswer_E" runat="server" MaxLength="3" Width="200px"></asp:TextBox>
        ...
        <td style="width:20%;">
            ...
            Text="زمان پاسخگویی را مشخص کنید"  ValidationGroup="edit" Display="Dynamic" 
            ErrorMessage="RequiredFieldValidator"></asp:RequiredFieldValidator>
            <asp:RangeValidator ID="RangeValidator2_E" runat="server" ControlToValidate="TextBox_TimeToAnswer_E" 
            Text=" حداقل 30 و حداکثر 180ثانیه، زمان پاسخگویی مجاز نیست"  ValidationGroup="edit" Display="Dynamic"  Type="Integer"
             MaximumValue="180"   MinimumValue="30"
             ErrorMessage="RangeValidator"></asp:RangeValidator>
    </td>
  ...
  <%--  Lessondescription                 Lessondescription                 Lessondescription          --%> 
    ...
    <tr>
        ...
        <td style="width:60%; text-align:center;">
                   <asp:Button ID="ButtonEdit_Lesson" runat="server" Text="ویرایش درس"  
            ValidationGroup="edit" onclick="ButtonEdit_Lesson_Click" 
           />
           &nbsp;&nbsp;&nbsp;&nbsp;
  ...
  onclick="Button_return_Click" 
    ...
    &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:DropDownList ID="DropDownList_groups" runat="server" DataValueField="id" 
         AppendDataBoundItems="true" AutoPostBack="true" DataTextField="GroupName" 
            onselectedindexchanged="DropDownList_groups_SelectedIndexChanged">
        <asp:ListItem Text=""></asp:ListItem>
        </asp:DropDownList>
        <br />  <br />
        <asp:CheckBoxList ID="CheckBoxList_Fields" runat="server" DataTextField="FieldName" Visible="false"
         RepeatColumns="5" RepeatDirection="Horizontal"      CellPadding="5" CellSpacing="1"
         DataValueField="id">
        </asp:CheckBoxList>
