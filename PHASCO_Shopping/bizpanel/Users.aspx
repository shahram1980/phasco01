<%@ Page Title="Users" Language="C#" MasterPageFile="~/Template/admin.Master" AutoEventWireup="true" CodeBehind="Users.aspx.cs" Inherits="PHASCO_Shopping.bizpanel.Users" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table align="center" class="style1">
        ...
        <tr>
            <td align="center">
                <asp:LinkButton ID="lnk_btn_allUsers" runat="server" 
                    onclick="lnk_btn_allUsers_Click">All Users</asp:LinkButton>
&nbsp; |&nbsp;
                    ...
                    <asp:View ID="View1" runat="server">
                        <table class="style1">
                            <tr>
                                ...
                                <cc1:PagerV2_8 ID="pager1"  PageSize="50" OnCommand="pager_Command" 
GenerateGoToSection="true"
GenerateHiddenHyperlinks="true" runat="server" />
                                    <asp:GridView ID="Gv_users" runat="server" AllowPaging="False" 
                                        AutoGenerateColumns="False" CellPadding="5" ForeColor="#333333" 
                                        GridLines="None" Width="500" 
                                        >
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnk_btn_UserSelect" runat="server" 
                                                        CommandArgument='<%# Eval("id") %>' oncommand="lnk_btn_UserSelect_Command">Detail</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                            ...
                            <tr>
                                <td colspan="2" width="50%">
                                    <asp:GridView ID="Gv_Search" runat="server" AllowPaging="True" 
                                        ...
                                        <RowStyle BackColor="#F7F6F3" ForeColor="#333333" />
                                        <Columns>
                                            <asp:BoundField DataField="DateIns" HeaderText="Date" 
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnk_btn_UserSelect0" runat="server" 
                                                        CommandArgument='<%# Eval("id") %>' oncommand="lnk_btn_UserSelect_Command">Detail</asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
