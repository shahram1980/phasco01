...
namespace ASPnetControls
{
    ...
    public class PagerV2_8 : WebControl, IPostBackEventHandler, INamingContainer
    {
        ...
        /// Default value: go
        /// </summary>
        private string _GO = Resources.Resource.GO;
        ...
        /// Default value: of
        /// </summary>
        private string _OF = Resources.Resource.of;
        [Category("Globalization")]
        ...
        /// Default value: From
        /// </summary>
        private string _FROM = Resources.Resource.From;
        [Category("Globalization")]
        ...
        /// Default value: Page
        /// </summary>
        private string _PAGE = Resources.Resource.Page;
        [Category("Globalization")]
        ...
        /// Default value: to
        /// </summary>
        private string _TO = Resources.Resource.To;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _SHOWING_RESULT = Resources.Resource.Showing_Results;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _SHOW_RESULT = Resources.Resource.Show_Result;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _BACK_TO_FIRST = Resources.Resource.to_First_Page;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _GO_TO_LAST = Resources.Resource.to_Last_Page;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _BACK_TO_PAGE = Resources.Resource.Back_to_Page;
        [Category("Globalization")]
        ...
        /// </summary>
        private string _NEXT_TO_PAGE = Resources.Resource.Next_to_Page;
        [Category("Globalization")]
        ...
        /// </summary>
        private bool _rightToLeft = Convert.ToBoolean(Resources.Resource.RightToLeft_bol.ToString());
        [Category("Globalization")]
        public bool RTL
        {
        ...
        {
            string templateCell = "<td style=\"padding:1px 1px 1px 1px;\" class=\"PagerOtherPageCells\"><div onclick=\"handleGoToVisibility()\" class=\"GoToLabel\">&nbsp;" + Resources.Resource.Go_To + "&nbsp;</div><img id=\"goto_img\" onclick=\"handleGoToVisibility()\" src=\"" + Page.ClientScript.GetWebResourceUrl(this.GetType(), "PHASCO_Shopping.Images.arr_right.gif") + "\" alt=\"\" class=\"GoToArrow\"/>&nbsp;<div id=\"div_goto\" style=\"display:none;\"><select class=\"GoToSelect\" name=\"ddlTes\" id=\"ddlTes\" onchange=\"javascript:handleGoto(this);\">{0}</select></div></td>";
        ...
        private string RenderGoToScript()
        {
            ...
            sb.AppendFormat("gotoImg.src = gotoElem.style.display == 'none' ? '{0}' : '{1}';",
                                    Page.ClientScript.GetWebResourceUrl(this.GetType(), "PHASCO_Shopping.Images.arr_right.gif"),
                                    Page.ClientScript.GetWebResourceUrl(this.GetType(), "PHASCO_Shopping.Images.arr_left.gif")
                                    );
            sb.Append("}");
        ...
        private string RenderHiddenDiv()
        {
            ...
            string tempHyperlink = "<a href=\"{0}\">صفحه {1}</a>";
