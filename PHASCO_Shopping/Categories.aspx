<%@ Page Language="C#"  MasterPageFile="~/Template/Biztbiz.Master"  AutoEventWireup="true" CodeBehind="Categories.aspx.cs" Inherits="PHASCO_Shopping.Categories" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table style="width: 900px;" class="direction">
        <tr>
                        ...
                        <td>
                         ...
                         <br />
                                        <table class="style1">
                                            <tr>
                                                <td>
                                                    <img alt="" src="../ADV/Homecompany_right.jpg" 
                                                        style="width: 237px; height: 529px" /></td>
                                            </tr>
                                            <tr>
                                                <td>
                                                    &nbsp;</td>
