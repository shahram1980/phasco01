...
namespace DataAccessLayer.BIZ
{
    public class TBL_User_Biz
    {
        ...
        public void TBL_User_Tra_Edit(int id,string mode, string Uid, string Password, int User_Status, string Business_Location,
            string Company, string Industry, string Given_Name, string Family_Name, string Tel_C_Code, string Tel_A_Code, string Tel_A_Number,
            string Mobile, int User_Level, int sex, int UsersRoleID, string email,string fax)
        {
            DataTable dt;
            ...
            param[15] = dal.MakeParam("@sex", SqlDbType.Int, sex, null);
            param[16] = dal.MakeParam("@UsersRoleID", SqlDbType.Int, UsersRoleID, null);
            param[17] = dal.MakeParam("@email", SqlDbType.NVarChar, email, null);
            param[18] = dal.MakeParam("@fax", SqlDbType.NVarChar, fax, null);
            dal.ExecSp("TBL_User_Tra", param);
           ...
           string Mobile, int User_Level, int sex, int UsersRoleID,string email,string fax)
        {
            ...
            param[18] = dal.MakeParam("@email", SqlDbType.NVarChar, email, null);
            param[19] = dal.MakeParam("@fax", SqlDbType.NVarChar, fax, null);
            dt = dal.ExecSpDt("TBL_User_Tra", param);
            return dt;
        }
        ...
        public DataTable TBL_User_cmd(string cmd)
        {
            DAL_BIZ dal = new DAL_BIZ();
            DataTable dtTemp = new DataTable();

            dtTemp = dal.Exec_Cmd(cmd);
            return dtTemp;
        }
    }
}
