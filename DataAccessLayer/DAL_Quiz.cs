...
namespace DataAccessLayer
{
    class DAL_Quiz
    {
           ...
           //   public SqlConnection Conn = new SqlConnection(@"Data Source=AGHAZADEH-PC\SQL2008_R2_A;Initial Catalog=PHASCO_Quiz;Integrated Security=True");
   public SqlConnection Conn = new SqlConnection(ConnectionString.Quiz());
