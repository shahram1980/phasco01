...
namespace DataAccessLayer
{
    class DAL_Main
    {
           ...
           //  public SqlConnection Conn = new SqlConnection(@"Data Source=AGHAZADEH-PC\SQL2008_R2_A;Initial Catalog=Phasco_Web;Integrated Security=True");
        public SqlConnection Conn = new SqlConnection(ConnectionString.Main());
