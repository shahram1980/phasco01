...
{
    public class TBL_Doctor_Properties
    {
        BaseDAL_Dir dal = new BaseDAL_Dir();
        DataTable dt = new DataTable();

        public DataTable TBL_Doctor_Properties_Tra(string Mode, int id, string Name, string NameEN, int star, string Address, string Manager, string Time, string Foods,
           string WebSite, string tel, string Pic, int ExpDate, int UID, int AllowView, string EMail)
        {
            ...
            return dal.ExecSpDt("TBL_Doctor_Properties_Tra", param);
        }
        public DataTable TBL_Doctor_Properties_Tra(string Mode)
        {
            int? getid = 0;
        ...
        public DataTable TBL_Doctor_Properties_Tra(string Mode, int id)
        {
            int? getid = 0;
        ...
        public DataTable TBL_Doctor_Properties_Tra(string Mode, string Name)
        {
            int? getid = 0;
            SqlParameter[] param = new SqlParameter[2];
            param[0] = dal.MakeParam("@mode", SqlDbType.NVarChar, Mode, null);
        ...
        public DataTable TBL_Doctor_Properties_Tra(string Mode, int id, string Pic)
        {
            int? getid = 0;
